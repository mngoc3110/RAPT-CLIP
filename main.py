...
loss_group.add_argument('--mi-warmup', type=int, default=0, help='Warmup epochs for MI loss (default: 0 = no warmup).')
loss_group.add_argument('--mi-ramp', type=int, default=0, help='Ramp-up epochs for MI loss (default: 0 = immediate full weight).')
...
loss_group.add_argument('--dc-warmup', type=int, default=0, help='Warmup epochs for DC loss (default: 0 = no warmup).')
loss_group.add_argument('--dc-ramp', type=int, default=0, help='Ramp-up epochs for DC loss (default: 0 = immediate full weight).')
