...
python main.py \
    ...
    --root-dir /kaggle/input/emotic \
    --train-annotation /kaggle/input/emotic/train.txt \
    --val-annotation /kaggle/input/emotic/val.txt \
    --test-annotation /kaggle/input/emotic/test.txt \
    --clip-path ViT-B/16 \
    --bounding-box-face /kaggle/input/emotic/emotic_face_bboxes.json \
    --bounding-box-body /kaggle/input/emotic/emotic_body_bboxes.json \
    --epochs 40 \
    --batch-size 32 \
    --print-freq 50 \
    --use-amp \
